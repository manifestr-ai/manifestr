...
export default function WhatToExpect() {
  return (
    <section className="w-full bg-white py-[80px] md:py-[96px]">
      <div className="max-w-[1280px] mx-auto px-6 md:px-[80px] flex flex-col gap-[60px] items-center">

        {/* Heading */}
        <div className="flex flex-col gap-[12px] items-end text-center w-full">
          <h2 className="text-[40px] md:text-[60px] leading-[1.2] md:leading-[72px] tracking-[-1.2px] text-black w-full">
          ...
          <p
            className="text-[14px] md:text-[16px] leading-[24px] text-[#52525b] w-full"
        ...
        {/* Steps */}
        <div className="flex flex-col items-start w-full max-w-[968px]">
          {STEPS.map((step, i) => (
            <motion.div
              key={step.num}
            ...
            >
              {/* Left — number + title (577px) */}
              <div
                className="flex items-center gap-[24px] shrink-0 w-[50%] md:w-[577px] h-full"
              >
                <span
                  className="text-[28px] md:text-[36px] leading-[44px] tracking-[-0.72px] text-black shrink-0"
                  style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontWeight: 700 }}
                >
                  {step.num}
                </span>
                <span
                  className="text-[24px] md:text-[36px] leading-[44px] tracking-[-0.72px] text-black"
                  style={{ fontFamily: "'Hanken Grotesk', sans-serif", fontWeight: 700 }}
                >
                  {step.title}
                </span>
                ...
                <div className="flex flex-col items-center h-full w-[11px] shrink-0">
                  ...
                  {!step.isLast && (
                    <motion.div
                      ...
                      className="flex-1 w-px bg-[#d1d5db] mt-[4px] origin-top opacity-100"
                    />
                  )}
                </div>

                {/* Description */}
                <div className="flex flex-col items-start w-[280px] md:w-[362px]">
                  <p
                    className="text-[14px] md:text-[16px] leading-[24px] text-[#18181b]"
                    style={{ fontFamily: "Inter, sans-serif", fontWeight: 400 }}
                  >
                    {step.desc}
                  </p>
