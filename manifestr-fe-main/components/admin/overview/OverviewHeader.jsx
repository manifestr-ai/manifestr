...
export default function OverviewHeader({
  ...
  return (
    <div className="flex flex-col gap-6 px-8 pt-8 pb-6  overflow-hidden">
      <div className="flex items-center justify-between">
        {/* Title block */}
        <div className="flex flex-col gap-2">
          <h1 className="text-[30px] leading-[38px] font-bold text-[#18181b]">
            {title}
          </h1>
          <p className="text-[16px] leading-6 font-normal text-[#71717a]">
            {subtitle}
          </p>
        </div>
