          ...
          const FolderContent = () => (
            <div className={`relative w-[125px] h-[90px]`}>
              <div
                ...
                //       ? "var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), 0 8px 16px 0 var(--tw-shadow-color, #16223314)"
                //       : "",
                // }}
              >
                <img
