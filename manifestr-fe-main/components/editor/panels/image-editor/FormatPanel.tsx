    ...
    <div className="h-[102px] bg-white border-b flex items-center px-6 gap-10 relative overflow-hidden">
      ...
      {pageIndex > 0 && (
        <button
          ...
          className="w-[32px] h-[64px] flex items-center justify-center mr-2 bg-white"
        >
          <svg
      ...
      <div className="overflow-hidden w-full">
        <div
          ...
          style={{ transform: `translateX(-${pageIndex * 400}px)` }}
        >
          {/* Left Label */}
          ...
          <div className="flex items-center gap-6">
            ...
            >
              ...
              <span className="text-[11px] mt-2 text-[#6B7280]">
                Blur/Sharp
              </span>
            </button>
      ...
      <button
        onClick={() => setPageIndex((p) => p + 1)}
        className="w-[32px] h-[64px] flex items-center justify-center ml-2 bg-white"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="13"
