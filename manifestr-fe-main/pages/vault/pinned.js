    ...
    const fetchPinnedDocuments = async () => {
      try {
        ...
        if (response.data.status === "success") {
          ...
          console.log(
            `🚀 BATCH: Fetching collaborators for ${projects.length} pinned projects...`,
          );
  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col overflow-y-auto">
        ...
        {isLoading ? (
          <div
            className="px-4 md:px-[38px] py-12 w-full text-center"
            style={{ height: "332px" }}
          >
          ...
          >
            ...
            <p className="text-gray-400 text-sm">
              Pin documents from the Vault to quickly access them here!
            </p>
          </div>
